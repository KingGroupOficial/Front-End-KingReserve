...
export default {
  ...
  methods:{
    ...
    savedEventHandler() {
      ...
      if (this.item.name && this.item.reserves_id && this.item.name && this.item.last_name && this.item.email && this.item.on_job_status && this.item.job_description) {
      ...
      <div class="p-fluid">
        ...
        <div class="p-field mt-5">
          <pv-float-label>
            ...
            <pv-input-text id="email" v-model="item.email" class="p-inputtext p-component" type="text"/>
